...
class RibbonTest {
    ...
    void getAllRibbonsListedAsStringShouldReturnLongString() {
        String expectedString = """
                ...
                - Main gun hit: 1 point (2 points for ships with gun caliber of 203mm up to 304mm as main armament, 3 points for ships with gun caliber of 305mm up to 405mm as main armament, 4 points for ships with gun caliber of 406mm and above as main armament)
                - Secondary hit: 1 point
                - Bomb hit: 3 points
                - Rocket hit: 3 points
                - Citadel hit: 20 points (40 points for ships with gun caliber of 203mm up to 304mm as main armament, 60 points for ships with gun caliber of 305mm up to 405mm as main armament, 80 points for ships with gun caliber of 406mm and above as main armament)
