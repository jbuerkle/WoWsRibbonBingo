...
class RibbonResultTest {
    ...
    void getValueShouldReturnCorrectValueWithAircraftAsMainArmamentType() {
        ...
        assertEquals(45, resultB.getAsTerm(MainArmamentType.AIRCRAFT).getValue());
    ...
    void getAsStringShouldReturnCorrectDisplayTextWithLargeCaliberGunsAsMainArmamentType() {
        ...
        assertEquals("Spotted: 3 * 30 points", resultB.getAsTerm(MainArmamentType.LARGE_CALIBER_GUNS).getAsString());
        assertEquals(
    ...
    void getAsStringShouldReturnCorrectDisplayTextWithAircraftAsMainArmamentType() {
        ...
        assertEquals("Spotted: 3 * 15 points", resultB.getAsTerm(MainArmamentType.AIRCRAFT).getAsString());
