...
class BingoResultTest {
    ...
    @Test
    void getMainArmamentTypeShouldReturnTheCorrectArmamentType() {
        BingoResult resultA = new BingoResult(MainArmamentType.MEDIUM_CALIBER_GUNS);
        BingoResult resultB = new BingoResult(MainArmamentType.LARGE_CALIBER_GUNS);
        BingoResult resultC = new BingoResult(MainArmamentType.EXTRA_LARGE_CALIBER_GUNS);
        assertEquals(MainArmamentType.MEDIUM_CALIBER_GUNS, resultA.getMainArmamentType());
        assertEquals(MainArmamentType.LARGE_CALIBER_GUNS, resultB.getMainArmamentType());
        assertEquals(MainArmamentType.EXTRA_LARGE_CALIBER_GUNS, resultC.getMainArmamentType());
    }
